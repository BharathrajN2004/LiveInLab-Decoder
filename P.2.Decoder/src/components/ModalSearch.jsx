        ...
        >
          ...
          <div className="py-4 px-2">
            ...
            <div className="mb-3 last:mb-0">
              <div className="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase px-2 mb-2">Recent Projects</div>
              <ul className="text-sm">
                <li>
                  ...
                  >
                    ...
                    <span>Women Safety App - 23 hours before</span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    ...
                    <span>Pond Quality Monitoring System</span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    ...
                    <span>Handler - Management System</span>
                  </Link>
                </li>
            ...
            {/* Recent pages */}
            <div className="mb-3 last:mb-0">
              <div className="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase px-2 mb-2">Recent Collaborations</div>
              <ul className="text-sm">
                <li>
                  <Link
                    className="flex items-center p-2 text-slate-800 dark:text-slate-100 hover:text-white hover:bg-indigo-500 rounded group"
                  ...
                  >
                    ...
                    <span>
                      <span className="font-medium">Inventory Management APP</span> -{' '}
                      <span className="text-slate-600 dark:text-slate-400 group-hover:text-white">Incubation / … / Bharathraj</span>
                    </span>
                  </Link>
                </li>
                <li>
                  ...
                  >
                    ...
                    <span>
                      <span className="font-medium">Teacher Validator</span> -{' '}
                      <span className="text-slate-600 dark:text-slate-400 group-hover:text-white">Team Indent / … / BhaargavGupta</span>
                    </span>
                  </Link>
                </li>
              </ul>
