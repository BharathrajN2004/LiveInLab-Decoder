...
function DropdownCommunity({
  ...
  return (
    <div className="relative inline-flex">
      ...
      >
        <span className="sr-only">Decode Community</span>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" viewBox="0 0 23 23" >
          <path className="fill-current text-slate-500 dark:text-slate-400" d="M6,13c-2.2,0-4,1.8-4,4s1.8,4,4,4s4-1.8,4-4S8.2,13,6,13z M12,3C9.8,3,8,4.8,8,7s1.8,4,4,4s4-1.8,4-4S14.2,3,12,3z M18,13 c-2.2,0-4,1.8-4,4s1.8,4,4,4s4-1.8,4-4S20.2,13,18,13z" />
        </svg>
      ...
      >
        ...
        >
          <div className="text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase pt-1.5 pb-2 px-3">Welcome to Decode Community</div>
          <ul>
            <li>
              <Link
