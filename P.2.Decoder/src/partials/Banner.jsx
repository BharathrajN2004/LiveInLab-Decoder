    ...
    { bannerOpen && (
      <div className="fixed bottom-0 right-0 w-full md:bottom-8 md:right-12 md:w-auto z-60">
        <div className="bg-slate-800 border border-transparent dark:border-slate-700 text-slate-50 text-sm p-3 md:rounded shadow-lg flex justify-between">
          <div className='text-slate-500 inline-flex'><a className="font-medium text-slate-50" target="_blank" rel="noreferrer">Welcome to the world of </a><a className=" ml-1 font-medium hover:underline text-emerald-400" target="_blank" rel="noreferrer">Decoder</a></div>
